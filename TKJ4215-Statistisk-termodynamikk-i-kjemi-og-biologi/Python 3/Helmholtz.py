...
def Calculate_F(m_AB):
    ...
    Density_of_states = [m_AB.count(state) for state in States]#Should return a list of length = to len(States) with the density of each state. Use list comprehension
