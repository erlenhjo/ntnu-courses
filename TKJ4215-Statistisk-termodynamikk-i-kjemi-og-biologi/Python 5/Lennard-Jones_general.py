from sympy import diff, symbols, sqrt, expr
import numpy as np


#***************YOUR INPUT HERE*************#
eps, sig, r, x, y, z= symbols('eps sig r x y z')
eps=1
sig=1

V = 4*eps*((sig/r)**12-(sig/r)**6)
V_cartesian=V.subs(r,(x**2+y**2+z**2)**(1/2))
print(V_cartesian)
vdiff=[diff(V_cartesian,v) for v in [x,y,z]]
#**************END YOUR INPUT HERE***********#
